...
const CERTIFICATIONS = {
  ...
  items: [
    ...
    { name: 'Fundamentals of MCP — The MCP Course', issuer: 'Hugging Face', date: 'Apr 2026', link: 'https://cdn-uploads.huggingface.co/production/uploads/noauth/e70CiZ_3huitm6t-c10a5.webp', image: import.meta.env.BASE_URL + 'certs/hf-mcp-fundamentals.webp' },
  ],
};
